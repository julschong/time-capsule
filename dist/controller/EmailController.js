...
var EmailController = /** @class */ (function () {
    function EmailController() {
        this.userRepository = typeorm_1.getRepository(Email_1.Email);
    }
    EmailController.prototype.all = function (request, response, next) {
    ...
    EmailController.prototype.one = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    EmailController.prototype.save = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    EmailController.prototype.remove = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var userToRemove;
            return __generator(this, function (_a) {
                switch (_a.label) {
